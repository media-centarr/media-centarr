defmodule MediaManager.Pipeline.Stages.ParseTest do
  use ExUnit.Case, async: true

  alias MediaManager.Pipeline.Payload
  alias MediaManager.Pipeline.Stages.Parse
  ...
  describe "run/1" do
    ...
    test "parses a TV episode file path" do
      payload = %Payload{
        file_path: "/media/TV/Breaking.Bad/Season.01/Breaking.Bad.S01E05.1080p.mkv"
      }
