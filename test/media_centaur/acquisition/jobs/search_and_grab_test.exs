defmodule MediaCentaur.Acquisition.Jobs.SearchAndGrabTest do
  use MediaCentaur.DataCase

  alias MediaCentaur.Acquisition.{Grab, Jobs.SearchAndGrab, Prowlarr}
  ...
  defp insert_grab(attrs \\ %{}) do
    {:ok, grab} =
      Grab.create_changeset(
        Map.merge(
          %{tmdb_id: "12345", tmdb_type: "movie", title: "Dune Part Two"},
          attrs
        )
      )
      |> Repo.insert()
